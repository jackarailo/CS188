...
def depthFirstSearch(problem):
    ...
    """
    # initialise the state with a search agent method queing policy
    fringe = util.Stack()
    ...
    exploredorFringeSet.add(problem.getStartState())
    while True:
        # check if the frontier has nodes to expand
        # if no return failure
        if fringe.isEmpty():
            print("No solution found")
            return None
        # expand the leaf node from the frontier
        leaf_node, pathActions, pathCost = fringe.pop()
